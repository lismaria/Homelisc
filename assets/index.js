$(document).ready(function () {
  ...
  $( "input[type=text]" ).focus(function() {
    $(".homepage-one, .signup-wrapper, .login-wrapper, .cuisine-wrapper").css({'min-height':init_vh*90+'px'});
  ...
  $( "input[type=text]" ).blur(function() {
    $(".homepage-one, .signup-wrapper, .login-wrapper, .cuisine-wrapper").css({'min-height':'auto'});
